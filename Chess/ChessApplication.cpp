...
void ChessApplication::createScene(void)
{
	...
	Ogre::Entity* blackRookEntity = mSceneMgr->createEntity("BlackRook", "rook_black.mesh");
	...
	Ogre::Entity* blackKnightEntity = mSceneMgr->createEntity("BlackKnight", "knight_black.mesh");
	...
	Ogre::Entity* blackBishopEntity = mSceneMgr->createEntity("BlackBishop", "bishop_black.mesh");
	...
	Ogre::Entity* blackKingEntity = mSceneMgr->createEntity("BlackKing", "king_black.mesh");
	...
	Ogre::Entity* blackQueenEntity = mSceneMgr->createEntity("BlackQueen", "queen_black.mesh");
	...
	Ogre::Entity* blackBishopEntity2 = mSceneMgr->createEntity("BlackBishop2", "bishop_black.mesh");
	...
	Ogre::Entity* blackKnightEntity2 = mSceneMgr->createEntity("BlackKnight2", "knight_black.mesh");
	...
	Ogre::Entity* blackRookEntity2 = mSceneMgr->createEntity("BlackRook2", "rook_black.mesh");
	...
	Ogre::Entity* blackPawnEntity = mSceneMgr->createEntity("BlackPawn", "pawn_black.mesh");
	...
	Ogre::Entity* blackPawnEntity2 = mSceneMgr->createEntity("BlackPawn2", "pawn_black.mesh");
	...
	Ogre::Entity* blackPawnEntity3 = mSceneMgr->createEntity("BlackPawn3", "pawn_black.mesh");
	...
	Ogre::Entity* blackPawnEntity4 = mSceneMgr->createEntity("BlackPawn4", "pawn_black.mesh");
	...
	Ogre::Entity* blackPawnEntity5 = mSceneMgr->createEntity("BlackPawn5", "pawn_black.mesh");
	...
	Ogre::Entity* blackPawnEntity6 = mSceneMgr->createEntity("BlackPawn6", "pawn_black.mesh");
	...
	Ogre::Entity* blackPawnEntity7 = mSceneMgr->createEntity("BlackPawn7", "pawn_black.mesh");
	...
	Ogre::Entity* blackPawnEntity8 = mSceneMgr->createEntity("BlackPawn8", "pawn_black.mesh");
	...
	Ogre::Entity* whitePawnEntity = mSceneMgr->createEntity("WhitePawn", "pawn_white.mesh");
	...
	Ogre::Entity* whitePawnEntity2 = mSceneMgr->createEntity("WhitePawn2", "pawn_white.mesh");
	...
	Ogre::Entity* whitePawnEntity3 = mSceneMgr->createEntity("WhitePawn3", "pawn_white.mesh");
	...
	Ogre::Entity* whitePawnEntity4 = mSceneMgr->createEntity("WhitePawn4", "pawn_white.mesh");
	...
	Ogre::Entity* whitePawnEntity5 = mSceneMgr->createEntity("WhitePawn5", "pawn_white.mesh");
	...
	Ogre::Entity* whitePawnEntity6 = mSceneMgr->createEntity("WhitePawn6", "pawn_white.mesh");
	...
	Ogre::Entity* whitePawnEntity7 = mSceneMgr->createEntity("WhitePawn7", "pawn_white.mesh");
	...
	Ogre::Entity* whitePawnEntity8 = mSceneMgr->createEntity("WhitePawn8", "pawn_white.mesh");
	...
	Ogre::Entity* whiteRookEntity = mSceneMgr->createEntity("WhiteRook", "rook_white.mesh");
	...
	Ogre::Entity* whiteKnightEntity = mSceneMgr->createEntity("WhiteKnight", "knight_white.mesh");
	...
	Ogre::Entity* whiteKingEntity = mSceneMgr->createEntity("WhiteKing", "king_white.mesh");
	...
	Ogre::Entity* whiteBishopEntity2 = mSceneMgr->createEntity("WhiteBishop2", "bishop_white.mesh");
	...
	l->setPosition(Ogre::Vector3(16.8, 30, 16.8));
